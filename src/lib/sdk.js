...
export const fetchMovieGenres = () => fetch('https://imdb8.p.rapidapi.com/title/list-popular-genres', {
  method: 'GET',
  headers: {
...
export const fetchMoviesByGenre = (genre) => fetch(
...
export const fetchMovieStreamingServices = (movieId) => fetch(
...
export const fetchMovieFromSearch = (query) => fetch(
...
export const createUserWithEmailAndPassword = (email, password) => Firebase
